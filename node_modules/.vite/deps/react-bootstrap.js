import {
  ...
  useWindow
} from "./chunk-5GE5HXNM.js";
import {
  Spinner_default
} from "./chunk-SCEP6WAR.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-GZACVOLD.js";
import {
  require_classnames
} from "./chunk-CPDWCT4W.js";
import {
  require_jsx_runtime
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-IMD6HU5L.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-UFYDDM7O.js";
import {
  require_react_dom
...
var FormControl = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime51.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames43.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormSelect = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime56.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames47.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var InputGroup = React63.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime63.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames52.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var ModalDialog = React75.forwardRef(({
  ...
  return (0, import_jsx_runtime74.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames56.default)(dialogClass, className, size && `${bsPrefix}-${size}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
...
var Pagination = React105.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames80.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames81.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var SplitButton = React111.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime118.jsxs)(Dropdown_default, {
  ref,
  ...props,
  ...
  children: [(0, import_jsx_runtime117.jsx)(Button_default2, {
    ...
    type,
    children: title
  }), (0, import_jsx_runtime117.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size,
    variant,
  ...
  }), (0, import_jsx_runtime117.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
