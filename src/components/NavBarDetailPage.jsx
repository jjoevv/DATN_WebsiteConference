...
import DateIcon from './../assets/imgs/submission_date.png'
import LocationDate from './../assets/imgs/location.png'
  ...
  return (
    <Container className='m-0 w-100 p-0 mw-100' fluid>
        ...
        <Container>
            ...
            {navs.map((navlink, index)=>
                <NavLink key={index} to={navlink.path}
                  className={
                    ...
                    ? "me-1 py-1 px-3 text-primary border-bottom border-1 border-primary"
                    : "me-1 py-1 px-3 "
                  }
                >
          ...
          <ButtonGroup>
            <Button className='me-2 bg-brown-normal text-brown-darker border-0 rounded-2'>Update Now</Button>
            <Button className='bg-red-normal border-0 rounded-2'>Follow</Button>
          </ButtonGroup>
        </Container>
      </Navbar>
      <Outlet/>
